  ...
  <div class="col-12">
     <div class="card">
        <div class="card-body pb-0">
           <h5 class="card-title">Kategori Jurusan</h5>
           <table class="table table-borderless">
              <thead>
                 <tr>
                    <th scope="col">No.</th>
                    <th scope="col">Jurusan</th>
                    <th scope="col" class="text-center">Sudah Memilih</th>
                    <th scope="col" class="text-center">/</th>
                    <th scope="col" class="text-center">Total Pemilih</th>
                 </tr>
              </thead>
              <tbody>
                 <tr>
