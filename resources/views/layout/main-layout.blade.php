...
<html lang="en">
   ...
   <body>
      <header id="header" class="header fixed-top d-flex align-items-center">
         <div class="d-flex align-items-center justify-content-between"> <a href="/home" class="logo d-flex align-items-center"> <img src="assets/img/logo.png" alt=""> <span class="d-none d-lg-block">Pemira</span> </a> <i class="bi bi-list toggle-sidebar-btn"></i></div>
      ...
      <aside id="sidebar" class="sidebar">
         <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
               <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#"> <i class='bx bx-data'></i><span>Kelola Data</span><i class="bi bi-chevron-down ms-auto"></i> </a>
               <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li> <a href="/admin/kandidat"> <i class="bi bi-circle"></i><span>Data Kandidat</span> </a></li>
                  <li> <a href="/admin/jurusan"> <i class="bi bi-circle"></i><span>Data Pemilih</span> </a></li>
               </ul>
            </li>
            <li class="nav-item"> <a class="nav-link collapsed" href="users-profile.html"><i class='bx bxs-doughnut-chart'></i> <span>Quick Count</span> </a></li>
            <li class="nav-item"> <a class="nav-link collapsed" href="/faq"> <i class='bx bx-question-mark'></i> <span>F.A.Q</span> </a></li>
         </ul>
      </aside>
         ...
         <div class="pagetitle">
            ...
            <nav>
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="/home">@yield('title')</a></li>
               </ol>
            </nav>
         </div>
      ...
      <footer id="footer" class="footer">
         <div class="copyright"> &copy; Copyright <strong><span>PROTIC & MEDICOM</span></strong>. All Rights Reserved</div>
      </footer>
